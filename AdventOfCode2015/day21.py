...
wpns = [(8, 4, 0), (10, 5, 0), (25, 6, 0), (40, 7, 0), (74, 8, 0)]
amrs = [(13, 0, 1), (31, 0, 2), (53, 0, 3), (75, 0, 4), (102, 0, 5), (0, 0, 0)]
rngs = [(25, 1, 0), (50, 2, 0), (100, 3, 0), (20, 0, 1), (40, 0, 2), (80, 0, 3), (0, 0, 0), (0, 0, 0)]
result = (min if stage == 'a' else max)(
    wc+ac+rc0+rc1 for wc,wd,_ in wpns for ac,_,aa in amrs for (rc0,rd0,ra0),(rc1,rd1,ra1) in combinations(rngs,2)
